...
// TODO: K Integrate changes in sendInvite instead.
func sendEncryptedInvite(
	...
	err = rsAPI.PerformEncryptedInvite(ctx, &api.PerformEncryptedInviteRequest{
		InviteInput: roomserverAPI.EncryptedInviteInput{
			RoomID:     *validRoomID,
			Inviter:    *inviter,
			Invitee:    *invitee,
			Reason:     reason,
